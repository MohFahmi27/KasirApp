 ...
 * @author MF
 */
public class Barang_Transaksi extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Barang_Transaksi
     */
...
//        int id = Integer.valueOf(lblid_detail.getText());
//        if (lblid_detail.getText().equals("")) {
//            btnedit.setVisible(false);
//        } else if(id>=1) {
...
//        }
    ...
    public JLabel getlblno_transaksi() {
        return lblno_transaksi;
    }
...
//    public JLabel getlblid_barang() {
//        return lblid_detail;
//    }
//    
//    public JLabel getlblkode() {
//        return lblid_kode;
//    }
    ...
    private void initComponents() {
        ...
        lblno_transaksi = new javax.swing.JLabel();
        ...
        setMinimumSize(new java.awt.Dimension(970, 597));
        ...
        lblno_transaksi.setFont(new java.awt.Font("Monospaced", 1, 12)); // NOI18N
        lblno_transaksi.setForeground(new java.awt.Color(255, 255, 255));
        lblno_transaksi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/safe-transaction.png"))); // NOI18N
        lblno_transaksi.setText("jLabel5");
        lblno_transaksi.setPreferredSize(new java.awt.Dimension(100, 45));
        jPanel8.add(lblno_transaksi);
    ...
    private void btntambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btntambahActionPerformed
        ...
        if (txtkode_barang.getText().equals("") || txtqty.getText().equals("") ||
            ...
            JOptionPane.showMessageDialog(rootPane, "Harap Isi Semua Data");
             ...
             JOptionPane.showMessageDialog(rootPane, "Stock Tidak Mencukupi");
             kosong();
         }
        else {
            try {
                String sql = "INSERT INTO detail_transaksi(no_transaksi,kode_barang,qty,sub_total) VALUES ('" +lblno_transaksi.getText()+ "','" +txtkode_barang.getText()+ "','" +txtqty.getText()+ "','"+txtharga.getText()+"')";
...
//        try {
//            String sql2 ="SELECT * FROM suku_cadang WHERE kode_barang='" +lblid_kode.getText()+ "'";
//            rs= sta.executeQuery(sql2);
//            if (rs.next()) {
//                int stock = Integer.valueOf(rs.getString("stock"));
//                int hasil = stock+1;
//                
//                String sql3 = "UPDATE suku_cadang SET stock = '" +hasil+ "' WHERE kode_barang='" +lblid_kode.getText()+ "'";
//                sta.executeUpdate(sql3);
//                
//            }
//            String sql = "UPDATE detail_transaksi SET kode_barang='" +txtkode_barang.getText()+ "',qty='" +txtqty.getText()+ "', '" +txtharga.getText()+ "' WHERE id_detail_transaksi = '" +lblid_detail.getText()+ "' ";
//            sta.executeUpdate(sql);
//            
//            JOptionPane.showMessageDialog(rootPane, "BERHASIL");
//            this.dispose();
...
//        }}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Barang_Transaksi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Barang_Transaksi().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblno_transaksi;
